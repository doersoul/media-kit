...
/// {@template media_kit_video_platform_controller}
///
/// MediaKitVideoPlatformController
/// -----------------------
///
/// This class provides the interface for platform specific [MediaKitVideoController] implementations.
/// The platform specific implementations are expected to implement the methods accordingly.
///
/// The subclasses are then used in composition with the [MediaKitVideoController] class, based on the platform the application is running on.
///
/// {@endtemplate}
abstract class MediaKitVideoPlatformController {
  /// The [Player] instance associated with this instance.
  final Player player;

  /// User defined configuration for [MediaKitVideoController].
  final MediaKitVideoConfiguration configuration;
