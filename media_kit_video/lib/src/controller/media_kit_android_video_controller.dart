...
///
/// MediaKitAndroidVideoController
/// ----------------------
///
/// The [MediaKitVideoPlatformController] implementation based on native JNI & C/C++ used on Android.
///
/// {@endtemplate}
class MediaKitAndroidVideoController extends MediaKitVideoPlatformController {
  /// Whether [MediaKitAndroidVideoController] is supported on the current platform or not.
  ...
  static Future<MediaKitVideoPlatformController> create(
    ...
    void listener() {
      ...
      if (value != null) {
        debugPrint('MediaKitAndroidVideoController: Texture ID: $value');
        completer.complete();
      }
    }
