...
import 'package:media_kit_video/src/util/media_kit_query_decoders.dart';
import 'package:synchronized/synchronized.dart';

/// {@template native_video_controller}
///
/// MediaKitNativeVideoController
/// ---------------------
///
/// The [MediaKitVideoPlatformController] implementation based on native C/C++ used on:
/// * Windows
/// * GNU/Linux
/// * macOS
/// * iOS
///
/// {@endtemplate}
class MediaKitNativeVideoController extends MediaKitVideoPlatformController {
  /// Whether [MediaKitNativeVideoController] is supported on the current platform or not.
  ...
  MediaKitNativeVideoController._(super.player, super.configuration)
  ...
  /// {@macro native_video_controller}
  static Future<MediaKitVideoPlatformController> create(
    Player player,
    ...
    // Creation:
    final controller = MediaKitNativeVideoController._(player, configuration);

    // Register [_dispose] for execution upon [Player.dispose].
    player.platform?.release.add(controller._dispose);

    // Store the [MediaKitNativeVideoController] in the [_controllers].
    ...
    void listener() {
      ...
      if (value != null) {
        debugPrint('MediaKitNativeVideoController: Texture ID: $value');
        completer.complete();
      }
    }
  ...
  /// Currently created [MediaKitNativeVideoController]s.
  /// This is used to notify about updated texture IDs & [Rect]s through [_channel].
  static final _controllers = HashMap<int, MediaKitNativeVideoController>();
